export class AppError extends Error {
  constructor(public status: 400 | 401 | 403 | 404, public code: string, message: string) {
    super(message);
  }
  static badRequest(msg: string, code = 'BAD_REQUEST') { return new AppError(400, code, msg); }
  static unauthorized(msg: string, code = 'UNAUTHORIZED') { return new AppError(401, code, msg); }
